...
export class GetOrganicReachService {
  ...
  getOrganicReachMonthly(pageId) {
    return this.http.get('https://graph.facebook.com/v2.8/'+pageId+'/insights/page_posts_impressions_organic?since=2017-01-01&until=2017-01-31&period=day&access_token='+this.fbAccessToken)
